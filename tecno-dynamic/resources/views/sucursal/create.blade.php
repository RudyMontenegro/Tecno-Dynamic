...
<form action="{{url('/sucursal/registrarSucursal')}}" class="form" id="newValidate" method="post" enctype="multipart/form-data">
...
<div class="row">
    ...
    <div class="col-6">
        ...
        value="{{ isset($sucursal->nombre)?$sucursal->nombre:old('nombre')  }}" onBlur="comprobarSucursal()" onkeyup="validarNombre()"
